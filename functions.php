<?php
/**
 * Ligature — theme entry point (thin loader, nothing more).
 *
 ...
 *
 * [CORE] This is the portable loader. The `ligature` CLI rewrites the namespace
 * and slug on the way into each theme it generates, so a shipped theme's
 * functions.php is byte-for-byte this file with `Ligature`/`ligature` swapped
