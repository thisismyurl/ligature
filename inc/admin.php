...
function get_started_content(): array {
	...
	$default = array(
		...
		'optimize'   => array(
			...
			__( 'It meets WCAG 2.2 AA — real focus outlines, a skip link, sensible heading order, and motion that respects a reduce-motion setting. Keep your own copy and images to that bar and the whole site stays welcoming.', 'ligature' ),
		),
