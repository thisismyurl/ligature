 ...
 * the skin (Ligature's personality). Each sheet depends on the previous so the
 ...
 * the ligature/preload_fonts filter (registered in inc/skin.php).
 *
...
function enqueue_assets(): void {
	...
	$sheets = array(
		...
		'skin'  => 'assets/css/skin.css',       // [SKIN] Ligature's layout, components, blocks, utilities.
	);
...
function preload_fonts(): void {
	 ...
	 */
	$fonts = (array) apply_filters( 'ligature/preload_fonts', array() );
